  ...
  return (
    <aside className="filter-sidebar" aria-label="Explorar y filtrar publicaciones">
      <div className="card filters-card">
        ...
        <div className="filter-tags">
          {popularTags.map((tag) => (
            <button
              key={tag}
              className={`tag ${props.tag === tag ? 'tag--active' : ''}`}
              aria-pressed={props.tag === tag}
              onClick={() =>
                props.onTagChange(props.tag === tag ? '' : tag)
              }
            >
              #{tag}
            </button>
        ...
        <button className="reset-filters" onClick={props.onReset}>
          Restablecer filtros
        </button>
      </div>
      ...
      <div className="community-note">
        ...
        <p>
          Cada experiencia compartida ayuda a nuestra comunidad a aprender.
        </p>
